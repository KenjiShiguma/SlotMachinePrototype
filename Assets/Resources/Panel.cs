...
// Start Date: 03/17/2020 9:30 PM | Last Edited: 03/17/2020 11:10 PM
...
public class Panel : MonoBehaviour
{
    ...
    public static Dictionary<PanelIcon, int> fruitScores; // Holds all fruit scores // TODO: Make this a Singleton
    ...
    private void Start()
    {
        ...
        if (fruitScores == null)
        {
            fruitScores = new Dictionary<PanelIcon, int>();
            fruitScores.Add(PanelIcon.Default, 0);
            fruitScores.Add(PanelIcon.Apple, 100);
            fruitScores.Add(PanelIcon.Kiwi, 100);
            fruitScores.Add(PanelIcon.Lemon, 100);
            fruitScores.Add(PanelIcon.Orange, 100);
            fruitScores.Add(PanelIcon.Peach, 100);
            fruitScores.Add(PanelIcon.Pear, 100);
            fruitScores.Add(PanelIcon.Pomegranate, 100);
            fruitScores.Add(PanelIcon.Watermelon, 100);
        }
    ...
    public void SetFruit(PanelIcon icon)
    {
        ...
        points = fruitScores[fruit]; // Set the value of the fruit
